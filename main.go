...
var etcdCAFile = flag.String("etcd_ca_file", "none", "trusted CA certificate for the etcd server")
var etcdCertFile = flag.String("etcd_cert_file", "none", "etcd client certificate")
var etcdKeyFile = flag.String("etcd_key_file", "none", "etcd client private key")
...
func main() {
	...
	conf = vipconfig.Config{IP: *ip, Mask: *mask, Iface: *iface, HostingType: *hostingType,
		...
		EtcdUser: *etcdUser, EtcdPassword: *etcdPassword, EtcdCAFile: *etcdCAFile,
		EtcdCertFile: *etcdCertFile, EtcdKeyFile: *etcdKeyFile, Interval: *interval}
